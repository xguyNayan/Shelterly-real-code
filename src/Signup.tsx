...
export default function Signup() {
  ...
  const renderDesktopLayout = () => (
    <>
      ...
      <div className="absolute top-6 left-0 p-8 md:p-12 md:top-12 lg:p-16 lg:top-24 z-20 max-w-lg hidden md:block">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 leading-tight">
          Find Your <span className="text-primary-300">Perfect</span> Space
        </h1>
        <p className="text-black/80 text-lg md:text-xl mb-6 leading-relaxed">
          Join thousands of students who've found their ideal college accommodation with Shelterly.
        </p>
        ...
        <div className="flex flex-col space-y-3 mt-6">
          <div className="flex items-center">
            ...
            <span className="text-black/90 text-sm md:text-base">Verified listings from trusted landlords</span>
          </div>
          <div className="flex items-center">
            <div className="w-8 h-8 rounded-full bg-primary-500/20 flex items-center justify-center mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span className="text-black/90 text-sm md:text-base">Virtual tours and detailed floor plans</span>
          </div>
          <div className="flex items-center">
            <div className="w-8 h-8 rounded-full bg-primary-500/20 flex items-center justify-center mr-3">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary-300" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span className="text-black/90 text-sm md:text-base">Roommate matching and secure payments</span>
          </div>
        </div>
      </div>
    </>
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full z-0 pointer-events-none">
        ...
        <div className="w-full h-full relative">
          ...
          <div className="absolute inset-0 md:transform md:translate-y-[20%] md:scale-100 hidden md:block">
            <Spline 
              scene="https://prod.spline.design/5anOsc7jP1kqjwgV/scene.splinecode" 
      ...
      {/* Responsive positioning of the Signup Form */}
      <div className="absolute inset-0 w-full h-full flex md:items-center md:justify-end items-end justify-center z-20 px-4 md:px-12 lg:px-20">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl font-bold text-primary-800 mb-1 text-center">Join Shelterly</h2>
            <p className="text-center text-gray-600 text-sm mb-5">Create your account in just a few steps</p>
            ...
            <form className="space-y-5" onSubmit={handleSignup}>
              <div className="space-y-1">
                <label htmlFor="fullName" className="text-xs font-medium text-gray-700 block ml-1">Full Name</label>
              ...
              <div className="flex items-start pt-1 pb-1">
                <input 
                  ...
                  name="terms" 
                  type="checkbox" 
                  className="h-3.5 w-3.5 mt-0.5 text-primary-500 focus:ring-primary-400 border-gray-300 rounded" 
                  checked={agreeTerms}
                  onChange={(e) => setAgreeTerms(e.target.checked)}
                  required
                />
                <label htmlFor="terms" className="ml-2 block text-xs text-gray-700">
                  I agree to the <a href="#" className="text-primary-600 hover:text-primary-500 transition">Terms of Service</a> and <a href="#" className="text-primary-600 hover:text-primary-500 transition">Privacy Policy</a>
                </label>
              </div>
      ...
      {/* Animated floating particles (desktop only) */}
      <div className="hidden md:block">
        {[...Array(6)].map((_, i) => (
          <div 
            key={i}
            className="absolute rounded-full bg-primary-300/30 animate-float"
            style={{
